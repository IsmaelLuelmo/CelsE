        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Curso = table.Column<string>(maxLength: 35, nullable: false),
                    ...
                    TelefonoAlumno = table.Column<string>(nullable: true),
                    EmailAlumno = table.Column<string>(nullable: true),
                    NombrePadre = table.Column<string>(nullable: true),
                    TelefonoPadre = table.Column<string>(nullable: true),
                    EmailPadre = table.Column<string>(nullable: true),
                    NombreMadre = table.Column<string>(nullable: true),
                    TelefonoMadre = table.Column<string>(nullable: true),
                    EmailMadre = table.Column<string>(nullable: true),
